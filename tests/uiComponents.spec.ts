...
await usingTheGridEmailInput.clear()                            //Simulate delaying key strokes  
await usingTheGridEmailInput.pressSequentially("test2@test.com")

//Generic Assertion of input field
...
//we need to pass the parameter force.True, by providing the force, true, we disabling the verification of different statuses that checkcommand is waiting for.
   ...
   test('dialog box', async({page}) => {
    ...
    while(!calenderMonthAndYear?.includes(expectedMonthAndYear)){
        ...
        calenderMonthAndYear = await page.locator('nb-calendar-view-mode').textContent()
                            ...
                            //Playwright find many locators 1,11,12(partial match) use exact match
